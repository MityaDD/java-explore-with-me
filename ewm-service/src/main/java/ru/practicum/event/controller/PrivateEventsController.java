...
public class PrivateEventsController {
    ...
    public EventFullDto addNewEvent(@PathVariable Long userId, @RequestBody @Valid NewEventDto eventDto) {
    ...
    @ResponseStatus(HttpStatus.OK)
    public EventRequestStatusUpdateResult changeRequestsStatus(@PathVariable Long userId, @PathVariable Long eventId,
